...
" Based On: https://github.com/joshdick/oncedark.vim/
...
let g:colors_name="brycedcarter_dark"
...
if !exists("g:brycedcarter_dark_termcolors")
  let g:brycedcarter_dark_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:brycedcarter_dark_terminal_italics")
  let g:brycedcarter_dark_terminal_italics = 0
endif
...
function! s:h(group, style)
  if g:brycedcarter_dark_terminal_italics == 0 && has_key(a:style, "cterm") && a:style["cterm"] == "italic"
    unlet a:style.cterm
  endif
  if g:brycedcarter_dark_termcolors == 16
...
let s:comment_grey = { "gui": "#5C6370", "cterm": "159", "cterm16": "15" }
...
call s:h("Search", { "fg": s:black, "bg": s:blue }) " Last search pattern highlighting (see 'hlsearch'). Also used for highlighting the current line in the quickfix window and similar items that need to stand out.
